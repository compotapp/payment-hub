...
COMMENT ON COLUMN outbox.message_type IS 'Тип сообщения, например: RESERVE_FUNDS, FUNDS_RESERVED';
COMMENT ON COLUMN outbox.transaction_id IS 'Идентификатор саги';
